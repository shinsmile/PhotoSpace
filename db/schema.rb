...
ActiveRecord::Schema.define(version: 20180530005903) do
  ...
  create_table "tagmanages", force: :cascade do |t|
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
  ...
  add_index "tagmanages", ["prototype_id"], name: "fk_rails_6488359045", using: :btree
  ...
  add_foreign_key "tagmanages", "prototypes"
  add_foreign_key "tagmanages", "tags"
end
